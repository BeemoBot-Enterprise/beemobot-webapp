...
const tabs = [
  {
    ...
    title: "Minesweeper",
    icon: "🍄",
    description: "Trouvez tous les champignons sans marcher dessus !",
    color: "honey",
  },
  {
    id: "guess",
    ...
    icon: "🎯",
    description: "Identifiez les champions par leurs compétences",
    color: "blue",
  },
  {
    id: "dodge",
    ...
    icon: "⚡",
    description: "Survivez aux skillshots !",
    color: "cyan",
  },
  {
    id: "trivia",
    title: "LoL Trivia",
    icon: "🧠",
    description: "Testez vos connaissances LoL",
    color: "purple",
  },
  {
    id: "memory",
    title: "Memory Match",
    icon: "🃏",
    description: "Associez les paires de champions",
    color: "gold",
  },
];
